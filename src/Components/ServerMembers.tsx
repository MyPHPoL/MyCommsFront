          ...
          <ul>
            {serverMembers.map((user) => ( // Fix the map function
              <li key={user.id} className="w-full">
                <div className="text-lg flex flex-col m-1 mb-2 font-semibold text-white mr-2 pl-2 border-[1px] border-tertiary hover:bg-secondary py-2 px-4 shadow w-full items-start">
