  ...
  return (
    <div>
      <div className="fixed h-full top-20 left-0 w-31 flex flex-col bg-primary shadow-lg">
        ...
        <ul className="m-4 first:my-0 last:my-0">
          <i>
            <IconButton icon={<IoAdd />} name={"Join Server"} />
          </i>
          <i>
...
const ServerButton = ({ name, picture }: ServerButtonProps) => (
  <div
    className="group font-semibold relative flex items-center justify-center h-12 w-12 mt-2 mb-2 mx-auto text-primary hover:rounded-xl rounded-3xl transition-all duration-300 ease-linear cursor-pointer shadow-lg;"
    style={{
